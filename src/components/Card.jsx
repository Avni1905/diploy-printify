...
const Card = () => {
    return (
        <div className='bg-gray-50'>
            <div className='container mx-auto py-8'> {/* Reduced py-14 to py-8 */}
                <div className='grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-8 mb-40'> {/* Reduced mb-60 to mb-40 */}
